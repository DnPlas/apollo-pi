...
class carDynamic():
    ...
    def updateRackPosition(self, isTurnLeft, isTurnRight, angle):
        position = -1
    ...
    def updateDistances(self, isTurnLeft, isTurnRight, angle):
    ...
    def updateMotorVelocities(self, isTurnLeft, isTurnRight, stateExcept):
        ...
        if stateExcept == 2:
            if isTurnRight:
                ...
                leftAngularVel = 60
                rightAngularVel = 30
        if isTurnRight and stateExcept == 1:
            leftAngularVel = 40
            rightAngularVel = 40
        
        elif not isTurnRight and stateExcept == 0:
            leftAngularVel = 40
            rightAngularVel = 40
